...
$("#preciosFinales").prepend(`<button id="btnPrecioFinal" class="btn btn-dark">Mostrar Precio Final con IVA</button>`);

$("#preciosFinales").append(`
<div id="div1">
    <h3>1 - Remera: $1815 <br> 2 - Pantalón: $2420 <br> 3 - Gorra: $1210</h3>
</div>
`);

$("#btnPrecioFinal").click( () => {
    $("#div1").toggle();
});
